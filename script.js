...
function handleGuess(letter) {
  ...
  if (currentWord.includes(letter)) {
    ...
    // Check if the word is complete after the correct guess
    if (isWordComplete()) {
      handleWin();
    }
  } else {
...
function handleWin() {
  ...
  if (score == 100) {
    ...
    messageElement.textContent = "🎉 You Win! Well done!";
...
function resetGame() {
  ...
  // Remove win board classes
  winBoard.classList.remove("win-board");
